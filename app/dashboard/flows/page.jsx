...
export function Dnd() {
  ...
  const NodeWrapper = (Component) => {
    const WrappedComponent = (props) => <Component {...props} removeNode={removeNode} />;
    WrappedComponent.displayName = `NodeWrapper(${Component.displayName || Component.name || "Component"})`;
